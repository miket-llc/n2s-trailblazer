    ...
    test_categories = [
        {
            ...
            "path": "tests/qa/",
            "desc": "QA Tests (PostgreSQL + Vector Search)"
        },
        {
            "env": {"TB_TESTING_PGVECTOR": "1"},
        ...
        },
        {
            "env": {"TB_TESTING_PGVECTOR": "1"},
            "path": "tests/cli/",
            "desc": "CLI Tests (PostgreSQL + Vector Search)"
        },
        {
            "env": {},
            "path": "tests/unit/",
            "desc": "Unit Tests (No Database)"
        },
        {
            "env": {},
            "path": "tests/policy/",
            "desc": "Policy Tests (No Database)"
        },
        {
            "env": {},
            "path": "tests/lint/",
            "desc": "Lint Tests (No Database)"
        }
    ]
