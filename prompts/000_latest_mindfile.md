...
Retrieval QA: var/retrieval_qc/<TS>/{ask_*.json,pack_stats.json,readiness.json,overview.md}
...
Artifacts: per-query ask_*.json, pack_stats.json, readiness.json, overview.md.
