...
from trailblazer.env_checks import assert_virtualenv_on_macos, _is_in_virtualenv, get_venv_info
...
class TestMacOSVenvEnforcement:
    ...
    def test_assert_virtualenv_bypass_with_env_var(self):
        ...
        with patch.dict(os.environ, {"TB_ALLOW_SYSTEM_PYTHON": "1"}), \
...
class TestVenvInfo:
    ...
    def test_get_venv_info_virtual_env(self):
        ...
        with patch('trailblazer.env_checks._is_in_virtualenv', return_value=True), \
    ...
    def test_get_venv_info_poetry(self):
        ...
        with patch('trailblazer.env_checks._is_in_virtualenv', return_value=True), \
             patch.dict(os.environ, {"POETRY_ACTIVE": "1", "POETRY_VENV_PATH": "/poetry/venv"}):
            info = get_venv_info()
    ...
    def test_get_venv_info_base_prefix(self):
        ...
        env_clear = {"VIRTUAL_ENV": None, "POETRY_ACTIVE": None, "CONDA_DEFAULT_ENV": None}
