...
def test_auto_since_reads_and_updates_state(tmp_path):
    ...
    with patch("trailblazer.core.paths.ROOT", tmp_path):
        ...
        with patch(
            ...
            # Mock CQL search to return pages modified since the state timestamp
            ...
            def mock_get_page_by_id(page_id, body_format="storage"):
                if page_id == "123":
                    return {
                        ...
                        "body": {
                            "storage": {"value": "<p>Updated content</p>"}
                        },
                        "_links": {"webui": "/page1"},
                    }
                elif page_id == "456":
            ...
            mock_client.get_attachments_for_page.return_value = iter(
                []
            )  # No attachments
...
def test_auto_since_warns_on_missing_state(tmp_path):
    ...
    try:
        with (
            ...
            patch(
                "trailblazer.pipeline.steps.ingest.confluence.log"
            ) as mock_log,
        ):
            mock_client = mock_client_class.return_value
            mock_client.site_base = "https://example.com"
